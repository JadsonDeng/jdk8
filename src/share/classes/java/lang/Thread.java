...
public class Thread implements Runnable {
    ...
    public enum State {
         ...
         * <p>
         * 等待状态，在调用了以下方法后进入此状态
         * 1. Object.wait()无超时的方法且未被notify()，如果被notify()RUNNABLE
         * 2. Thread.join()无超时的方法
         * 3. LockSupport.join()无超时的方法
         */
        WAITING,
         ...
         * </ul>
         * <p>
         * 超时等待状态，在调用了以下方法后进入超时等待状态：
         * 1。 Thread.sleep()
         * 2. Object.wait(time)方法后且未到超时时间前，如果达到了超时或被notify()了会进入RUNNABLE状态
         * 3. Thread.joni()方法后
